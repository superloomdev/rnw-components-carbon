...
const CURRENT_FLAT = [
  ...
  'ContentSwitcher', 'ControlledPasswordInput', 'CopyButton', 'DataTable', 'DataTableCell', 'DataTableHeader',
  'DataTableHeaderSelected', 'DataTableRow', 'DateInput',
  'DatePicker', 'DatePickerInput', 'DefinitionTooltip', 'DocumentViewer', 'Dropdown',
  'ErrorBoundaryContext', 'ErrorState', 'ExpandableSearch', 'FilterableMultiSelect', 'FlexGrid',
  'Form', 'FormContext', 'FormGroup', 'FormItem', 'FormLabel', 'GrantPermission', 'Grid', 'Header',
  ...
  'SelectableTile', 'SelectItem', 'SelectItemGroup', 'SelectableTag', 'ShapeIndicator', 'SidePanel', 'Skeleton',
